...
namespace ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Controllers
{
    ...
    public partial class AccountController : BaseController
    {
        ...
        private ApplicationSignInManagerRepository _signInManager;

        public ApplicationSignInManagerRepository SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<ApplicationSignInManagerRepository>();
            }
        ...
        public virtual async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", Resource.UsernameOrPasswordWasNotValid);
                    return View(model);
            }
        }
