...
using ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Manage;
...
namespace ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Controllers
{
    ...
    public partial class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManagerRepository userManager)
        {
        ...
        public virtual async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                .TwoFactorBrowserRememberedAsync(User.Identity.GetUserId<long>().ToString())
            };
            return View(model);
        }
        ...
        public virtual ActionResult LinkLogin(string provider)
        {
            ...
            return new AccountController.
                ChallengeResult(provider,
                                ...
                                User.Identity.GetUserId<long>().ToString());
        }
        ...
        public virtual async Task<ActionResult> LinkLoginCallback()
        {
            var loginInfo = await AuthenticationManager.
                                    GetExternalLoginInfoAsync(XsrfKey,
                                    User.Identity.GetUserId<long>().ToString());
            if (loginInfo == null)
            {
