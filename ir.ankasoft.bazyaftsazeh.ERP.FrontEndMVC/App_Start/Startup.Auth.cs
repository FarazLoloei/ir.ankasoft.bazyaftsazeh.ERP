...
namespace ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC
{
	public partial class Startup
	{
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<ApplicationUserManagerRepository>(ApplicationUserManagerRepository.Create);
            app.CreatePerOwinContext<ApplicationRoleManagerRepository>(ApplicationRoleManagerRepository.Create);
            app.CreatePerOwinContext<ApplicationSignInManagerRepository>(ApplicationSignInManagerRepository.Create);
            ...
            .OnValidateIdentity<ApplicationUserManagerRepository, ApplicationUser, long>(
                validateInterval: TimeSpan.FromMinutes(30),
