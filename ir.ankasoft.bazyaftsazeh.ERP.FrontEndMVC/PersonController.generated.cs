...
namespace ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Controllers
{
    public partial class PersonController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Detail = "~/Views/Person/_Detail.cshtml";
            public readonly string _List = "~/Views/Person/_List.cshtml";
            public readonly string CommunicationList = "~/Views/Person/CommunicationList.cshtml";
            public readonly string Create = "~/Views/Person/Create.cshtml";
            public readonly string Index = "~/Views/Person/Index.cshtml";
            public readonly string Modify = "~/Views/Person/Modify.cshtml";
            public readonly string PostalAddressList = "~/Views/Person/PostalAddressList.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PersonController : ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Controllers.PersonController
    {
        ...
        [NonAction]
        partial void ModifyOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Person.ViewModelModifyPerson request);

        [NonAction]
        public override System.Web.Mvc.ActionResult Modify(ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Person.ViewModelModifyPerson request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Modify);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "request", request);
        ...
        [NonAction]
        partial void CreatePostalAddressOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long parentId);

        [NonAction]
        public override System.Web.Mvc.ActionResult CreatePostalAddress(long parentId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CreatePostalAddress);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "parentId", parentId);
            CreatePostalAddressOverride(callInfo, parentId);
            return callInfo;
        }

        [NonAction]
        partial void CreatePostalAddressOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.PostalAddress.ViewModelCreateModifyPostalAddress request);

        [NonAction]
        public override System.Web.Mvc.ActionResult CreatePostalAddress(ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.PostalAddress.ViewModelCreateModifyPostalAddress request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CreatePostalAddress);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "request", request);
            CreatePostalAddressOverride(callInfo, request);
            return callInfo;
        }
