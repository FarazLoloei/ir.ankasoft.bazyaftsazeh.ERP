...
{
    public partial class ImperfectionController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ImperfectionController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ImperfectionController Actions { get { return MVC.Imperfection; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Imperfection";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Imperfection";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Detail = "~/Views/Imperfection/_Detail.cshtml";
            public readonly string _List = "~/Views/Imperfection/_List.cshtml";
            public readonly string Create = "~/Views/Imperfection/Create.cshtml";
            public readonly string Index = "~/Views/Imperfection/Index.cshtml";
            public readonly string Modify = "~/Views/Imperfection/Modify.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ImperfectionController : ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Controllers.ImperfectionController
    {
        public T4MVC_ImperfectionController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Imperfection.ViewModelCreateAndModifyImperfection request);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Imperfection.ViewModelCreateAndModifyImperfection request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "request", request);
        ...
        [NonAction]
        partial void ModifyOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Imperfection.ViewModelCreateAndModifyImperfection request);

        [NonAction]
        public override System.Web.Mvc.ActionResult Modify(ir.ankasoft.bazyaftsazeh.ERP.FrontEndMVC.Models.Imperfection.ViewModelCreateAndModifyImperfection request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Modify);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "request", request);
