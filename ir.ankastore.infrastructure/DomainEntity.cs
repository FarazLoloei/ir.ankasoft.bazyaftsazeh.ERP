...
namespace ir.ankasoft.infrastructure
{
    ...
    public abstract class DomainEntity<T> : IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return item.recId.Equals(recId);
        }
        ...
        public override int GetHashCode()
        {
            if (!IsTransient())
            {
                return recId.GetHashCode() ^ 31; // XOR for random distribution (http://blogs.msdn.com/b/ericlippert/archive/2011/02/28/guidelines-and-rules-for-gethashcode.aspx)
            }
