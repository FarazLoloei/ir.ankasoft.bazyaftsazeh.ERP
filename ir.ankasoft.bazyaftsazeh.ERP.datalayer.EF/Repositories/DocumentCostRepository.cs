...
{
    public class DocumentCostRepository : Repository<DocumentCost>, IDocumentCostRepository
    {
        public override IEnumerable<DocumentCost> LoadByFilter(IFilterDataSource request,
                                           out int totalRecords)
        {
            IQueryable<DocumentCost> objects = FindAll(x => x.Title.Title.Contains(request.keyword),
